...
<head>
    ...
    <link rel="stylesheet" href="prettier/mateributton.css">
        ...
        <div class="container">
            <div class="row">
              <div class="col-lg-2 mb-2" style="margin-left: 10px; margin-right: 17px;">
                <img src="{{asset('prettier/images/pkbm.png')}}" width="40" height="50" class="d-inline" style="" alt="">
              </div>
    ...
    <div class="collapse navbar-collapse" id="navbarNav" style="margin-left: 110px;">
        <ul class="navbar-nav">
            ...
            <div class="dropdown" style="margin-left: 15px;">
                <button class="dropbtn" onclick="myFunction()" style="color: #F7DE06;">Pengaturan
