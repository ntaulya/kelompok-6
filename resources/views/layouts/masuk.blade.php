  ...
  {{-- NAVBAR --}}
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #3167AF">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarNav">
          <ul class="navbar-nav">
              <li class="nav-masuk">
                <a class="nav-link" style="color: #fff; margin-right: 10px" href="/masuk">Masuk</a>
              </li>
              <li class="nav-daftar">
                <button class="btn btn-primary" style="background-color: #F7DE06; margin-right: 30px; color: #3167AF;" name="submit" type="submit"><a href="/daftar" style="text-decoration:none"><b>Daftar</b></a></button>
              </li>
          </ul>
        </div>
    </nav>
